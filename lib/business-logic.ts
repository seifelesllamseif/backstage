...
/** Task workflow. The six-column board renders the first six in order; `canceled` and `duplicate` are side-states. */
...
/** Columns shown on the project board, in left-to-right order. Excludes side-states. */
