...
The SKAM dark-theme tokens that landed in step 7 ([0014](0014-step-7-polish-scope.md)) live in this same file — `styles/globals.css` is the single CSS surface for the app.
