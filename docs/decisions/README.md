...
- [0018 — Profile pages (bento port)](0018-profile-pages.md) — every crew_member gets `/people/[id]`, `/profile` redirects, six new columns on crew_member (bio/avatarUrl/socials/languages), framer-motion fade-in, edit deferred.
