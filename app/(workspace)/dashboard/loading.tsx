// Skeleton for /dashboard while fetchDashboardData resolves. Mimics
// the DashboardShell chrome — left rail, topbar, 6-column board strip —
// so the first paint isn't a blank screen. Pure CSS, no JS.
